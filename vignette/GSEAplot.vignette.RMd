...
The GSESplot function was make to be compatible with other data sets, whether the data comes from another source or is modified by the user. Instructions for how to loading, running, and modifying a gene set database are detailed in the sections of the manuscript. 
